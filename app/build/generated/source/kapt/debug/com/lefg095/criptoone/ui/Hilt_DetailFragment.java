 ...
 */
public abstract class Hilt_DetailFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_DetailFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((DetailFragment_GeneratedInjector) this.generatedComponent()).injectDetailFragment(UnsafeCasts.<DetailFragment>unsafeCast(this));
    }
  }
