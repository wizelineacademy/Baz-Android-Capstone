...
import com.example.readbitso.datasource.room.dao.db.AppDatabase
...
class DataSourceModule {
    ...
    @Provides
    @Singleton
    fun userdao(db: AppDatabase): CriptocurrenciesDao = db.criptoCurrenciesDao()

    @Provides
    @Singleton
    fun transactionsdao(db: AppDatabase): TradesDao = db.tradingBookDao()

    @Provides
    @Singleton
    fun askbidsdao(db: AppDatabase): AskBidsDao = db.askAndBidsDao()
}
